    ...
    <div class="bg0 m-t-23 p-b-140">
        <div class="container">
            <section class="bg0 p-t-23 p-b-140">
                <div class="container">
                    <div class="p-b-10">
                        <h3 class="ltext-103 cl5">All Books</h3>
                    </div>

                    <div class="row isotope-grid">
                        <?php
                        $query = mysqli_query($con, "SELECT id as pid, BookImage1, BookName, BookPriceBeforeDiscount, BookPriceAfterDiscount FROM tblbooks ORDER BY pid DESC");
                                ...
                                <div class="block2-txt flex-w flex-t p-t-14">
                                    <div class="block2-txt-child1 flex-col-l">
                                        ...
                                        <span class="stext-105 cl3">
                                            </span> Rs.<?php echo htmlentities($row['BookPriceAfterDiscount']); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
